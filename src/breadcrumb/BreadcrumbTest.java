...
public class BreadcrumbTest {
    ...
    private static void createImages() {
        ...
        for (int i = 0; i < 5; i++) {
            final Image image = new Image(Display.getCurrent(), BreadcrumbTest.class.getResourceAsStream(fileNames[i]));
            images[i] = image;
        }
    }
    ...
    private static void createButtonsBreadCrumb(final Shell shell) {
        ...
        createBreadcrumb(shell, SWT.BORDER, SWT.CENTER | SWT.DROP_DOWN, false);
        new Label(shell, SWT.NONE);
